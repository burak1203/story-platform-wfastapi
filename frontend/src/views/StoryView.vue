  ...
  <div class="min-h-screen bg-slate-50 text-slate-900 dark:bg-slate-900 dark:text-slate-100">
    ...
    <main class="mx-auto max-w-3xl px-4 py-6">
      ...
      <template v-else-if="reader.story">
        ...
        <ul v-else class="mt-3 divide-y divide-slate-200 overflow-hidden rounded-xl border border-slate-200 dark:divide-slate-800 dark:border-slate-800">
